...
import { Organization, Term } from '../organization.model';
...
export class OrganizationEditorComponent {
  ...
  terms: string[] = Object.values(Term);
  ...
  constructor(
    ...
    this.organizationForm.setValue({
      ...
      accepting_members: this.organization.accepting_members,
      application: this.organization.application,
      term: this.organization.term
    });
